    ...
    <Layout>
      <View style={styles.container}>
        ...
        <View style={styles.imageRow}>
          <Image source={require('../assets/ganado.png')} style={styles.image} />
          <Image source={require('../assets/vacunas.png')} style={styles.image} />
          <Image source={require('../assets/peso.png')} style={styles.image} />
        </View>

        <Text style={styles.subtitle}>
          Gestiona inventarios, control sanitario y productividad desde cualquier lugar.
        </Text>
